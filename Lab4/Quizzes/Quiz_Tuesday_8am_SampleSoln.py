...
def Tu8_SampleSoln_Func2(clothes_list):
...
if __name__ == "__main__":
    ...
    Tu8_SampleSoln_Func2(test_input1)
    Tu8_SampleSoln_Func2(test_input2)
    Tu8_SampleSoln_Func2(test_input3)
