...
if __name__ == '__main__':
    ...
    if (do_exceptions):
        ...
        # This third way of doing things is the best practice - to anticipate certain kinds of errors and proceed depending on this - and raise an exception if we encounter something unexpected
        try:
